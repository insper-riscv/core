...
@GENERIC_MUX_4X1.testcase
async def tb_GENERIC_MUX_4X1_case_stress(dut: GENERIC_MUX_4X1, trace: lib.Waveform):
...
@GENERIC_MUX_4X1.testcase
async def tb_GENERIC_MUX_4X1_case_stress_3_bits(dut: GENERIC_MUX_4X1, trace: lib.Waveform):
    bits = 3
