...
async def tb_GENERIC_MUX_2X1(dut: GENERIC_MUX_2X1):
    ...
    for index, (source_1, source_2, selector, destination) in enumerate(zip(values_source_1, values_source_2, values_selector, values_destination)):
        ...
        assert condition, f"Error in test {index}: source_1={source_1} source_2={source_2} selector={selector}"
        await Timer(Decimal(1), units="ns")
