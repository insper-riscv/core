...
async def tb_CPU_TOP_LEVEL_LUI(dut: CPU_TOP_LEVEL, trace: utils.Trace):
    values_destination = [
...
@CPU_TOP_LEVEL.testcase
async def tb_CPU_TOP_LEVEL_AUIPC(dut: CPU_TOP_LEVEL, trace: utils.Trace):
    values_destination = [
        "00000000000000000000000000000000",
        "00000000000000000000000000000000",
        "UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU",
...
def test_CPU_TOP_LEVEL_BUILD_INSTRUCTIONS_testcases():
