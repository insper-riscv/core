...
**Figura 22** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Execução
...
**Figura 23** - Topologia do Componente de CPU Extensor de _bits_ para STORE
...
**Figura 24** - Topologia do Componente de CPU Extensor de Sinal para LOAD
...
**Figura 25** - Topologia do Módulo Controlador da Unidade de Execução
...
**Figura 26** - Topologia do Módulo Unidade de Execução
...
**Figura 27** - Topologia do Módulo Unidade de Controle
...
**Figura 28** - Topologia do Módulo Contador de Programa
...
**Figura 29** - Topologia do Módulo Banco de Registradores
...
**Figura 30** - Topologia do Módulo Escrita no Retorno
...
**Figura 31** - Topologia do Módulo Comparação para Desvio
...
**Figura 32** - Topologia do Módulo Desvio
...
**Figura 33** - Topologia da Etapa IF
...
**Figura 34** - Topologia da Etapa ID
...
**Figura 35** - Topologia da Etapa EX
...
**Figura 36** - Topologia da Etapa MEM
...
**Figura 37** - Topologia da Etapa WB
