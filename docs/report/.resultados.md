...
**Figura 43** - Topologia da Etapa IF
...
**Figura 44** - Topologia da Etapa ID
...
**Figura 45** - Topologia da Etapa EX
...
**Figura 46** - Topologia da Etapa MEM
...
**Figura 47** - Topologia da Etapa WB
...
**Figura 48** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Execução
...
**Figura 49** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Desvio
...
**Figura 50** - Topologia do Componente de CPU Unidade de Controle de Hazard
