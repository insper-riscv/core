...
de saída. Esse componente está ilustrado na Figura 23.

![MUX 32x1](/images/reference/report_components/generic_mux_32x1.drawio.svg)
**Figura 23** - Topologia do Componente Genérico Multiplexador de trinta e duas entradas
...
**Figura 24** - Topologia do Componente Genérico Memória ROM
...
**Figura 25** - Topologia do Componente Genérico Memória RAM
...
vetor de múltiplos zeros. Esse componente está ilustrado na Figura 26.

![Registrador Genérico](/images/reference/report_components/generic_register.drawio.svg)
**Figura 26** - Topologia do Componente Genérico Registrador
...
secundário. Esse componente está ilustrado na Figura 27.

![alt text](/images/reference/report_components/generic_comparator.drawio.svg)
**Figura 27** - Topologia do Componente Genérico Comparador

#### 3.1.11 Extensor de Sinal (Genérico)

Componente que extende o sinal de um vetor de dados de 32 _bits_, ilustrado na Figura 28.

![alt text](/images/reference/report_components/generic_signal_extender.drawio.svg)
**Figura 28** - Topologia do Componente Genérico Comparador
...
**Figura 29** - Topologia do Componente RV32I Deslocador da ULA
...
_bits_ para decidir qual operação será realizada. Esse componente está ilustrado na Figura 30.

![alt text](/images/reference/report_components/rv32i_alu.drawio.svg)
**Figura 30** - Topologia do Componente RV32I Unidade Lógica e Aritmética
...
valor de _carry_,  _overflow_ e slt. Esse componente está ilustrado na Figura 31.

![alt text](/images/reference/report_components/rv32i_alu_bit.drawio.svg)
**Figura 31** - Topologia do Subcomponente RV32I ULA _bit_
...
componente está ilustrado na Figura 32.

![alt text](/images/reference/report_components/rv32i_alu_controller.drawio.svg)
**Figura 32** - Topologia do Componente RV32I Unidade de Controle da ULA
...
nos registradores apontados pelos outros dois endereços. Esse componente está ilustrado na Figura 33.

![alt text](/images/reference/report_components/rv32i_register_file.drawio.svg)
**Figura 33** - Topologia do Componente RV32I Banco de Registradores
...
de saída. Esse componente está ilustrado na Figura 34.

![alt text](/images/reference/report_components/rv32i_branch_controller.drawio.svg)
**Figura 34** - Topologia do Componente RV32I Controlador de Desvio
...
Módulo que implementa a Unidade de Controle da ULA. Esse módulo está ilustrado na Figura 35.

![Módulo Controlador da Unidade de Execução](/images/reference/report_components/module_execution_unit_controller.drawio.svg)
**Figura 35** - Topologia do Módulo Controlador da Unidade de Execução

#### 3.3.2 Módulo Unidade de Execução

Módulo que implementa a ULA. Esse módulo está ilustrado na Figura 36.

![Módulo Unidade de Execução](/images/reference/report_components/module_execution_unit.drawio.svg)
**Figura 36** - Topologia do Módulo Unidade de Execução
...
**Figura 37** - Topologia do Módulo Unidade de Controle

#### 3.3.4 Módulo Contador de Programa

Módulo que implementa o Contador de Programa, que é um Registrador Genérico. Esse módulo está ilustrado na Figura 38.

![Módulo Contador de Programa](/images/reference/report_components/module_program_counter.drawio.svg)
**Figura 38** - Topologia do Módulo Contador de Programa

#### 3.3.5 Módulo Banco de Registradores
	
Módulo que implementa o Banco de Registradores. Esse módulo está ilustrado na Figura 39.

![Módulo Banco de Registradores](/images/reference/report_components/module_register_file.drawio.svg)
**Figura 39** - Topologia do Módulo Banco de Registradores

#### 3.3.6 Módulo Escrita no Retorno

Módulo que implementa o multiplexador de escrita no banco de registradores. Esse módulo está ilustrado na Figura 40.

![Módulo Escrita no Retorno](/images/reference/report_components/module_write_back.drawio.svg)
**Figura 40** - Topologia do Módulo Escrita no Retorno

#### 3.3.7 Módulo Comparação para Desvio

Módulo que implementa o comparador. Esse módulo está ilustrado na Figura 41.

![Módulo Comparação para Desvio](/images/reference/report_components/module_branch_compare_unit.drawio.svg)
**Figura 41** - Topologia do Módulo Comparação para Desvio

#### 3.3.8 Módulo Desvio

Módulo que implementa a lógica que determina o endereço de destino de uma instrução de desvio. 
Esse módulo está ilustrado na Figura 42.

![Módulo Desvio](/images/reference/report_components/module_branch_unit.drawio.svg)
**Figura 42** - Topologia do Módulo Desvio
...
![alt text](/images/reference/report_components/module_memory_interface.drawio.svg)
**Figura 43** - Topologia do Módulo Desvio
...
**Figura 44** - Topologia da Etapa IF
...
Essa etapa está ilustrada na Figura 45.

![Etapa ID](/images/reference/report_components/cpu_stage_id.drawio.svg)
**Figura 45** - Topologia da Etapa ID
...
**Figura 46** - Topologia da Etapa EX
...
Extensor de Sinal para LOAD implementados. Essa etapa está ilustrada na Figura 47.

![Etapa MEM](/images/reference/report_components/cpu_stage_mem.drawio.svg)
**Figura 47** - Topologia da Etapa MEM
...
**Figura 48** - Topologia da Etapa WB
...
para resolver um _hazard_ de dado. Esse componente está ilustrado na Figura 49.

![alt text](/images/reference/report_components/cpu_execution_forwarding_unit.drawio.svg)
**Figura 49** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Execução
...
dado. Esse componente está ilustrado na Figura 50.

![alt text](/images/reference/report_components/cpu_branch_forwarding_unit.drawio.svg)
**Figura 50** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Desvio
...
**Figura 51** - Topologia do Componente de CPU Unidade de Controle de Hazard

#### 3.4.9 _Top Level_ (CPU)

Componente que integra os outros componentes da etapa CPU, ilustrado na Figura 52.

![alt text](/images/reference/report_components/cpu_top_level.drawio.svg)
**Figura 52** - Topologia do Componente de CPU _Top Level_

### 3.5 Nível de Visão Geral do Projeto

O nível composto apenas pelo componente _top level_ que integra a CPU com as memórias,
como ilustrado na Figura 53.

![alt text](../public/images/reference/report_components/project_top_level.drawio.svg)
**Figura 53** - Topologia do Componente _Top Level_ do Projeto