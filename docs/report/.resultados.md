...
#### 3.1.3 Multiplexador de trinta e duas entradas (Genérico)

Componente que recebe trinta e dois vetores de entrada de múltiplos _bits_, quantidade de _bits_ ajustável de acordo 
com a 
necessidade, e recebe um seletor de 5 _bits_, e dependendo do valor do seletor, um dos valores de entrada passa a ser valor 
de saída. Esse componente está ilustrado na Figura 13.

![MUX 4x1](../public/images/reference/report_components/generic_mux_32x1.drawio.svg)
**Figura 13** - Topologia do Componente Genérico Multiplexador de trinta e duas entradas
...
**Figura 14** - Topologia do Componente Genérico Memória ROM
...
**Figura 15** - Topologia do Componente Genérico Memória RAM
...
**Figura 16** - Topologia do Componente Genérico Registrador
...
**Figura 17** - Topologia do Componente Genérico Comparador
...
**Figura 18** - Topologia do Componente RV32I Deslocador da ULA
...
**Figura 19** - Topologia do Componente RV32I Unidade Lógica e Aritmética
...
#### 3.1.13 Conversor de _Bits_ (RV32I)

Componente que formata um vetor de dados ram de acordo com as especificações
do processador RISC-V sobre como as instruções devem lidar com dados destinados à/vindos da memória.

![alt text](../public/images/reference/report_components/rv32i_type_converter.drawio.svg)
**Figura 23** - Topologia do Componente RV32I Conversor de _Bits_
...
**Figura 24** - Topologia do Módulo Controlador da Unidade de Execução
...
**Figura 25** - Topologia do Módulo Unidade de Execução
...
**Figura 26** - Topologia do Módulo Unidade de Controle
...
**Figura 27** - Topologia do Módulo Contador de Programa
...
**Figura 28** - Topologia do Módulo Banco de Registradores
...
**Figura 29** - Topologia do Módulo Escrita no Retorno
...
**Figura 30** - Topologia do Módulo Comparação para Desvio
...
**Figura 31** - Topologia do Módulo Desvio

#### 3.2.8 Módulo Interface de Memória

Módulo que implementa a formatação de dados que entram e saem da memória ram de acordo com as especificações
do processador RISC-V por meio o componente conversor de _bits_.

![alt text](../public/images/reference/report_components/module_memory_interface.drawio.svg)
**Figura 32** - Topologia do Módulo Interface de Memória
...
![Etapa MEM](../public/images/reference/report_components/cpu_stage_mem.drawio.svg)
...
**Figura 38** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Execução
...
**Figura 39** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Desvio
...
**Figura 40** - Topologia do Componente de CPU Unidade de Controle de Hazard
...
**Figura 41** - Página inicial do site de documentação (DIAS, L. F.; RUGGIERO, G. V.; SEIXAS, T. V., 2024)
