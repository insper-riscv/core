...
<figure style="text-align: left;">
    <img src="/images/quartus_actions.png" width="700" style="margin: 0 auto;">
    <figcaption>
        <strong>Figura 12</strong> - Logs Quartus.
    </figcaption>
</figure>
...
<figure style="text-align: left;">
    <img src="/images/actions_cases.png" width="700" style="margin: 0 auto;">
    <figcaption>
        <strong>Figura 13</strong> - Casos de testes no Github Actions.
    </figcaption>
</figure>
...
<figure style="text-align: left;">
    ...
    <figcaption>
        <strong>Figura 14</strong> - Botão para a execução dos testes de stress.
    </figcaption>
</figure>
...
<figure style="text-align: left;">
    ...
    <figcaption>
        <strong>Figura 15</strong> - Menu de testes do VSCode.
    </figcaption>
</figure>
...
<figure style="text-align: left;">
    <img src="/images/buttons_quartus_exp.png" width="800" style="margin: 0 auto;">
    <figcaption>
...
**Figura 17** - Página inicial do site de documentação (DIAS, L. F.; RUGGIERO, G. V.; SEIXAS, T. V., 2024)
...
**Figura 22** - Topologia do Componente Genérico Multiplexador de trinta e duas entradas
...
**Figura 28** - Topologia do Componente RV32I Deslocador da ULA
...
**Figura 29** - Topologia do Componente RV32I Unidade Lógica e Aritmética
...
**Figura 30** - Topologia do Subcomponente RV32I ULA _bit_
...
**Figura 31** - Topologia do Componente RV32I Unidade de Controle da ULA
...
**Figura 32** - Topologia do Componente RV32I Banco de Registradores
...
**Figura 33** - Topologia do Componente RV32I Controlador de Desvio
...
**Figura 34** - Topologia do Módulo Controlador da Unidade de Execução
...
**Figura 35** - Topologia do Módulo Unidade de Execução
...
**Figura 36** - Topologia do Módulo Unidade de Controle
...
**Figura 37** - Topologia do Módulo Contador de Programa
...
**Figura 38** - Topologia do Módulo Banco de Registradores
...
**Figura 39** - Topologia do Módulo Escrita no Retorno
...
**Figura 40** - Topologia do Módulo Comparação para Desvio
...
**Figura 41** - Topologia do Módulo Desvio
...
**Figura 51** - Topologia do Componente de CPU _Top Level_
...
**Figura 52** - Topologia do Componente _Top Level_ do Projeto