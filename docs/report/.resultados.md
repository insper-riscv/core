...
**Figura 18** - Topologia do Componente Genérico _Carry_ _Lookahead_
...
**Figura 19** - Topologia do Componente Genérico Somador
...
**Figura 20** - Topologia do Componente Genérico Multiplexador de duas entradas
...
**Figura 21** - Topologia do Componente Genérico Multiplexador de quatro entradas
...
**Figura 22** - Topologia do Componente Genérico Memória ROM
...
**Figura 23** - Topologia do Componente Genérico Memória RAM
...
vetor de múltiplos zeros. Esse componente está ilustrado na Figura 24.

![Registrador Genérico](/images/reference/report_components/generic_register.drawio.svg)
**Figura 24** - Topologia do Componente Genérico Registrador
...
secundário. Esse componente está ilustrado na Figura 25.

![alt text](/images/reference/report_components/generic_comparator.drawio.svg)
**Figura 25** - Topologia do Componente Genérico Comparador
...
**Figura 26** - Topologia do Componente RV32I Deslocador da ULA
...
_bits_ para decidir qual operação será realizada. Esse componente está ilustrado na Figura 27.

![alt text](/images/reference/report_components/rv32i_alu.drawio.svg)
**Figura 27** - Topologia do Componente RV32I Unidade Lógica e Aritmética
...
valor de _carry_,  _overflow_ e slt. Esse componente está ilustrado na Figura 28.

![alt text](/images/reference/report_components/rv32i_alu_bit.drawio.svg)
**Figura 28** - Topologia do Subcomponente RV32I ULA _bit_
...
componente está ilustrado na Figura 29.

![alt text](/images/reference/report_components/rv32i_alu_controller.drawio.svg)
**Figura 29** - Topologia do Componente RV32I Unidade de Controle da ULA
...
nos registradores apontados pelos outros dois endereços. Esse componente está ilustrado na Figura 30.

![alt text](/images/reference/report_components/rv32i_register_file.drawio.svg)
**Figura 30** - Topologia do Componente RV32I Banco de Registradores
...
de saída. Esse componente está ilustrado na Figura 31.

![alt text](/images/reference/report_components/rv32i_branch_controller.drawio.svg)
**Figura 31** - Topologia do Componente RV32I Controlador de Desvio
...
Módulo que implementa a Unidade de Controle da ULA. Esse módulo está ilustrado na Figura 32.

![Módulo Controlador da Unidade de Execução](/images/reference/report_components/module_execution_unit_controller.drawio.svg)
**Figura 32** - Topologia do Módulo Controlador da Unidade de Execução

#### 3.2.2 Módulo Unidade de Execução

Módulo que implementa a ULA. Esse módulo está ilustrado na Figura 33.

![Módulo Unidade de Execução](/images/reference/report_components/module_execution_unit.drawio.svg)
**Figura 33** - Topologia do Módulo Unidade de Execução
...
**Figura 34** - Topologia do Módulo Unidade de Controle

#### 3.2.4 Módulo Contador de Programa

Módulo que implementa o Contador de Programa, que é um Registrador Genérico. Esse módulo está ilustrado na Figura 35.

![Módulo Contador de Programa](/images/reference/report_components/module_program_counter.drawio.svg)
**Figura 35** - Topologia do Módulo Contador de Programa

#### 3.2.5 Módulo Banco de Registradores
	
Módulo que implementa o Banco de Registradores. Esse módulo está ilustrado na Figura 36.

![Módulo Banco de Registradores](/images/reference/report_components/module_register_file.drawio.svg)
**Figura 36** - Topologia do Módulo Banco de Registradores

#### 3.2.6 Módulo Escrita no Retorno

Módulo que implementa o multiplexador de escrita no banco de registradores. Esse módulo está ilustrado na Figura 37.

![Módulo Escrita no Retorno](/images/reference/report_components/module_write_back.drawio.svg)
**Figura 37** - Topologia do Módulo Escrita no Retorno

#### 3.2.7 Módulo Comparação para Desvio

Módulo que implementa o comparador. Esse módulo está ilustrado na Figura 38.

![Módulo Comparação para Desvio](/images/reference/report_components/module_branch_compare_unit.drawio.svg)
**Figura 38** - Topologia do Módulo Comparação para Desvio

#### 3.2.8 Módulo Desvio

Módulo que implementa a lógica que determina o endereço de destino de uma instrução de desvio. 
Esse módulo está ilustrado na Figura 39.

![Módulo Desvio](/images/reference/report_components/module_branch_unit.drawio.svg)
**Figura 39** - Topologia do Módulo Desvio
...
**Figura 40** - Topologia da Etapa IF
...
Essa etapa está ilustrada na Figura 41.

![Etapa ID](/images/reference/report_components/cpu_stage_id.drawio.svg)
**Figura 41** - Topologia da Etapa ID
...
**Figura 42** - Topologia da Etapa EX
...
Extensor de Sinal para LOAD implementados. Essa etapa está ilustrada na Figura 43.

![Etapa MEM](/images/reference/report_components/cpu_stage_mem.drawio.svg)
**Figura 43** - Topologia da Etapa MEM
...
**Figura 44** - Topologia da Etapa WB
...
para resolver um _hazard_ de dado. Esse componente está ilustrado na Figura 45.

![alt text](/images/reference/report_components/cpu_execution_forwarding_unit.drawio.svg)
**Figura 45** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Execução
...
dado. Esse componente está ilustrado na Figura 46.

![alt text](/images/reference/report_components/cpu_branch_forwarding_unit.drawio.svg)
**Figura 46** - Topologia do Componente de CPU Unidade de Encaminhamento de Dados para Desvio
...
está ilustrado na Figura 47.

![alt text](/images/reference/report_components/cpu_hazard_control_unit.drawio.svg)
**Figura 47** - Topologia do Componente de CPU Unidade de Controle de Hazard
...
SEIXAS, T. V., 2024) e que está ilustrado na Figura 48, hospedado no GitHub Pages utilizando de VitePress, uma
...
**Figura 48** - Página inicial do site de documentação (DIAS, L. F.; RUGGIERO, G. V.; SEIXAS, T. V., 2024)
