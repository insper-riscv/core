...
O cronograma seguido do projeto pode ser visto na Tabela Cronograma:

<table class="cronograma" width="100%">
    <thead>
        <tr>
...
Além da Gaisler, a empresa a SiFive, também desenvolve IPs cores para a linha de FPGAs da Microchip, utilizando o seu ecossistema chamado Mi-V. Essa linha de FPGAs inclui placas tolerantes a radiação(MICROCHIP, 2022).
...
Atualmente para o ecossistema de software do RISC-V, existem diversas ferramentas de desenvolvimento, como os compiladores GCC (GCC, [s.d.]) e LLVM (LLVM, [s.d.]), para linguagens como C e C++.  Além disso, a ferramenta de _debug_ GDB (GDB, [s.d.]) também é compatível com a arquitetura. 
