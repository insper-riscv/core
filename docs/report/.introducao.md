...
desses componentes, que são tecnologias cujo uso se dá por meio de licenças, pode comprometer 
o desenvolvimento destes programas no Brasil por oferta do mercado ou conflitos de interesse.

Por isso, o desenvolvimento do RISC-V, uma arquitetura aberta gerida por uma entidade internacional
da qual o Brasil faz parte desde março de 2024 (2024, MINISTÉRIO DA CIÊNCIA, TECNOLOGIA E INOVAÇÃO), 
é de vital interesse, tanto para a nação brasileira, quanto para a RISC-V International e todos os
países que estão presentes nesta organização. 
...
está especificado em anexo (Anexo A), e quaisquer futuras iterações do projeto devem
