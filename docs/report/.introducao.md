...
![Topologia do Top Level](/images/reference/components/top_level_core.drawio.svg "**Figura 1** - Diagrama do processador implementado, ilustração baseada em um simulador
_web_ de RISC-V (MARIOTTI; GIORGI, 2022)")
...
O cronograma do projeto pode ser visto na Tabela 1:
...
O mapeamento dos _stakeholders_ pode ser visto na Tabela 2:
...
**Tabela 2** - Tabela de mapeamento dos _stakeholders_
