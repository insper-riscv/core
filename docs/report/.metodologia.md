...
![alt text](/images/reference/report_components/nivel_genericos.drawio.svg "**Figura 2** - Diagrama dos componentes genéricos implementados")
![alt text](/images/reference/report_components/nivel_rv32i.drawio.svg "**Figura 3** - Diagrama dos componentes RV32I implementados")
...
![alt text](/images/reference/report_components/nivel_módulos.drawio.svg "**Figura 4** - Diagrama dos módulos implementados")
...
- Também faz parte do nível da CPU a implementação do _top level_ do processador, que é a integração dos elementos que compõem o mesmo, ou seja, a integração dos outros elementos que estão no nível da CPU como está ilustrado na Figura 6. 
...
![alt text](/images/reference/report_components/nivel_processador.drawio.svg "**Figura 6** - Diagrama de Visão Geral da CPU")

- Por fim, tem-se o nível de visão geral do projeto, com a implementação da CPU e das memórias usadas para teste, 
ilustrado na Figura 7.

![alt text](/images/reference/report_components/nivel_geral.drawio.svg "**Figura 7** - Diagrama de Visão Geral do Projeto")
...
Para os testes do _Quartus_, utilizado para o desenvolvimento na FPGA, foi criado através da linha de comando do próprio as seguintes etapas de compilação: _Synthesis_, _Elaboration_, _Fitter_ e _Timing Analysis_. Essas etapas podem ser executadas tanto localmente, através de botões no _VSCode_, mostrados na Figura 7, quanto no _GitHub Actions_, que executa automaticamente após um _push_ no repositório do projeto na pasta "/src".
...
<figure style="text-align: left;">
    ...
    <figcaption>
        <strong>Figura 8</strong> - Espaço de testes coberto por testes unitários.
    </figcaption>
</figure>
...
<figure style="text-align: center;">
    ...
    <figcaption>
        <strong>Figura 10</strong> - Espaço de testes coberto por testes exaustivos.
    </figcaption>
</figure>
...
<figure style="text-align: center;">
    ...
    <figcaption>
        <strong>Figura 11</strong> - Espaço de testes coberto pelo CRV
    </figcaption>
</figure>
