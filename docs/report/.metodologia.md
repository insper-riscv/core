...
![](/images/reference/report_components/nivel_genericos.drawio.svg "**Figura 2** - Diagrama dos componentes genéricos implementados"){width="80%"}

![](/images/reference/report_components/nivel_rv32i.drawio.svg "**Figura 3** - Diagrama dos componentes RV32I implementados"){width="80%"}

![](/images/reference/report_components/nivel_módulos.drawio.svg "**Figura 4** - Diagrama dos módulos implementados"){width="80%"}

![](/images/reference/report_components/nivel_etapas.drawio.svg "**Figura 5** - Diagrama das etapas implementadas"){width="80%"}

![](/images/reference/report_components/nivel_processador.drawio.svg "**Figura 6** - Diagrama de Visão Geral da CPU"){width="80%"}

![](/images/reference/report_components/nivel_geral.drawio.svg "**Figura 7** - Diagrama de Visão Geral do Projeto"){width="80%"}
...
<figure style="text-align: left;">
    ...
    <figcaption>
        <strong>Figura 8</strong> - Diagrama do fluxo de testes.
    </figcaption>
</figure>
