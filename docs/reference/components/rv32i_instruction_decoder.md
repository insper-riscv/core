...
<img src="/images/reference/components/rv32i_instruction_decoder_netlist.svg" alt="Diagrama de RTL do Decodificador de Instruções" style="width: 100%; background-color: white;">
